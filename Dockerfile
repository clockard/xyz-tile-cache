...
# Pin to 1.26.4 to fix CVE-2026-42504 (MIME header decoding in stdlib, fixed in 1.26.4).
...
RUN apk add --no-cache gdal gdal-tools py3-gdal gdal-driver-png gdal-driver-jpeg \
 ...
 && apk add --no-cache "openssl>=3.5.7-r0" "libcrypto3>=3.5.7-r0" "libssl3>=3.5.7-r0"
