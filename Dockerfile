...
# os.Root symlink-following traversal fixed in 1.26.5) are included.
...
# Upgrade google.golang.org/grpc to 1.82.1+ to fix GHSA-hrxh-6v49-42gf (xDS RBAC and HTTP/2 vulnerabilities)
