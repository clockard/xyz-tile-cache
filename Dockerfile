...
WORKDIR /src
# Upgrade golang.org/x/net to 0.55.0+ to fix CVE-2026-25681/27136/39821 (XSS, IDNA privilege escalation)
# Upgrade golang.org/x/crypto to 0.52.0+ to fix CVE-2026-39828/39829/39830/39831/39832/39835/42508/46595/46597 (SSH vulnerabilities)
...
RUN apk add --no-cache gdal gdal-tools py3-gdal gdal-driver-png gdal-driver-jpeg openjdk25-jre\
 ...
 && apk add --no-cache "libcurl>=8.21.0-r0" "curl>=8.21.0-r0" "libexpat>=2.8.2-r0" \
