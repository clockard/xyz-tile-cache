...
# openssl/libcrypto3/libssl3 pinned to 3.5.8-r0+ to fix CVE-2026-14456 (QUIC server
# unbounded memory growth DoS). giflib pinned to 5.2.2-r2+ to fix CVE-2026-26740
# (buffer overflow in EGifGCBToExtension).
