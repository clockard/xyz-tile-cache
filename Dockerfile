...
WORKDIR /src
# Upgrade golang.org/x/net to 0.55.0+ to fix CVE-2026-25681/27136/39821 (HTML XSS, idna Punycode)
# Upgrade golang.org/x/crypto to 0.52.0+ to fix CVE-2026-39828..39832/39835/42508/46595/46597 (ssh pkg)
...
RUN apk add --no-cache gdal gdal-tools py3-gdal gdal-driver-png gdal-driver-jpeg openjdk25-jre\
 ...
 && apk add --no-cache "c-ares>=1.34.8-r0" "libcurl>=8.21.0-r0" "libexpat>=2.8.2-r0" "p11-kit>=0.26.2-r0" "p11-kit-trust>=0.26.2-r0"
